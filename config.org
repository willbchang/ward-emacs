...
#+end_src
*** Ivy Prescient
[[https://github.com/raxod502/prescient.el][Ivy Prescient]] sorts candidates by most recently used.
#+begin_src emacs-lisp
...
** Diff HL
[[https://github.com/dgutov/diff-hl][diif-hl]] highlights uncommitted changes in the left fringe.
#+begin_src emacs-lisp
(use-package diff-hl
  :config
  (global-diff-hl-mode))
