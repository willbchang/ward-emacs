...
** Minibuffer
Disable startup minibuffer message.
#+begin_src emacs-lisp
...
;; https://reddit.com/r/emacs/comments/a6yrqx/
(defun ivy-find-file-in-project ()
  "Find file recursively in current project."
  (interactive)
  (let ((input (ivy--input)))
    (ivy-quit-and-run (counsel-file-jump))))

(global-set-key (kbd "s-p") 'ivy-find-file-in-project)
...
(use-package magit
  ...
  (defun magit-disable-fringe()
    "Disable fringe in `magit-mode'."
    (setq left-fringe-width 0
          right-fringe-width 0))
  
  (add-hook 'magit-mode-hook 'magit-disable-fringe))
#+end_src
