...
Hide org headline stars and space completely.
# https://www.reddit.com/r/emacs/comments/9wukv8/hide_all_stars_in_org_mode/e9pkggv?utm_source=share&utm_medium=web2x&context=3
#+begin_src emacs-lisp
(defun org-remove-stars ()
...
(add-hook 'org-mode-hook #'org-remove-stars)
#+end_src
