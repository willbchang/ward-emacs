...
(set-face-foreground 'org-headline-done "gray")
...
*** Persistent Scratch
[[https://github.com/Fanael/persistent-scratch][Persistent scratch]] can preserve the scratch buffer across Emacs sessions.
#+begin_src emacs-lisp
...
** Undo Tree
[[https://www.emacswiki.org/emacs/UndoTree][Undo tree]] provides persistant undo and redo even if Emacs is restarted.
#+begin_src emacs-lisp
