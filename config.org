...
(use-package rainbow-delimiters
  ...
  (rainbow-delimiters-depth-2-face ((t (:foreground "sienna1"))))
  (rainbow-delimiters-depth-3-face ((t (:foreground "lime green"))))
  (rainbow-delimiters-depth-4-face ((t (:foreground "deep sky blue"))))
  (rainbow-delimiters-depth-5-face ((t (:foreground "dark orange"))))
...
(use-package org
  ...
  :config
  ;; Make verbatim highlight text background with yellow.
